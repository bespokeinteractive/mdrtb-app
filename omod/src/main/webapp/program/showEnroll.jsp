...
<form id="programEnroll" action="${pageContext.request.contextPath}/module/mdrtb/programDetails/programEnroll.form?patientId=${patientId}&patientProgramId=-1" method="post" >
